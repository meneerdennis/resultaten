...
- Never put private keys, passwords, or service-account JSON into client-side environment variables (REACT_APP_*). Use server-side secrets in Actions or server environments.
